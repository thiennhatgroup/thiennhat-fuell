// Cau hinh ket noi Supabase — app Ton kho Xang dau.
// Lay o: Supabase Dashboard -> Project Settings -> API
//   Project URL -> supabaseUrl ; anon public key -> supabaseAnonKey
// (moi bang bat RLS khong policy => anon chi goi duoc cac RPC trong supabase/migrations/*.sql)
window.APP_CONFIG = {
